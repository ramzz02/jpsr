...
<?php
  ...
  $app_business_name = $viewprofiledetail['business_name'];
			...
			<div class="row">
				<div class="col-md-12 col-lg-8">
					...
					<div class="single_property_title">
						<div class="media">
							<img class="mr-3 buz_logo_UNqI" src="<?php echo $logo_base64_IMg; ?>" alt="Business Logo">
				...
				<div class="col-lg-12 pl0 pr0 pl15-767 pr15-767 text-align-right"><br>
					...
					<div class="link_share">
						...
						<span><a id="whatsapp" class="frontend_whatsapp" href="https://web.whatsapp.com/send?text=<?php echo "https://jpsr.in/business-profile.php?profID_view=".$viewprofiledetail['id']."/BusinessName=".$app_business_name.""; ?>" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i> WhatsApp</a></span>
