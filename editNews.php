<?php include("header.php");
	...
	$sql="select * from newsreport where id='$id' ";
			...
			<div class="row">
				...
				<div class="col-lg-12 mb10">
					<div class="breadcrumb_content style2 mb25">
						<h2 class="breadcrumb_title text-thm"><i class="fa fa-newspaper-o"></i>Edit  News</h2>
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-lg-#">
								<div class="my_profile_setting_input ui_kit_select_search form-group">
									...
									<option selected="true" value="<?php echo $row['language']?>"><?php echo $row['language']?></option>
									<option>Tamil</option>
							...
							<div class="col-lg-4">
								<div class="my_profile_setting_input form-group">
							    	...
							    	<input type="text" class="form-control" name="title" required placeholder="Enter the details here" value="<?php echo $row['title']?>">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="my_profile_setting_input form-group">
							...
							<div class="col-lg-2">
								<h5>News Image <span class="text-danger">(*)</span></h5>
							  	<div class="upload_file_input_add_remove">
							    	<img src="uploads/<?php echo $row['newsimage']; ?>" width="100"  />
														<input type="hidden"  name="photo" value="<?php echo $row['newsimage']; ?>"  />
														
														<span class="btn_upload"><input class="form-control" type="file" id="photo" name="photo"  ><span class="flaticon-upload"></span></span>
							...
							<div class="col-lg-10">
								<div class="my_profile_setting_textarea">
								    ...
								    <input class="form-control" type="text" id="des" name="des" value="<?php echo $row['newsdescription	']; ?>" >
								</div>
							</div>
						</div>
					</div>
					<div class="row">			
						<div class="col-lg-9" align="right">
							...
							<div class="col-lg-3" align="right">
								<button class="btn btn-thm listing_save_btn mt30" type="submit" name="updatenews"><i class="fa fa-sign-in"></i> Submit</button>
							</div>
						</div>
					</form>
					<?php
