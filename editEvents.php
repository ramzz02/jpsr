			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="breadcrumb_content style2">
						<h2 class="breadcrumb_title text-thm"><i class="fa fa-bank"></i>Edit Events</h2>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<form action="edit.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="my_dashboard_review">
						<div class="row">
							...
							<div class="col-lg-4">
								<div class="my_profile_setting_input form-group">
							    	<label for="listingPlace">Event Title <span class="text-danger">*</span></label>
							    	<input type="text" class="form-control" name="title" required placeholder="Enter the details here" value="<?php echo $row['eventTitle'];?>">
								</div>
							</div>
							...
							<div class="col-lg-4">
								<div class="my_profile_setting_input ui_kit_select_search form-group">
									...
									<input type="text" class="form-control" name="event" required placeholder="Enter the details here" value="<?php echo $row['eventDate'];?>">
								</div>
							</div>
								...
								<div class="my_profile_setting_input ui_kit_select_search form-group">
									...
									<input type="text" class="form-control" name="des" required placeholder="Enter the details here" value="<?php echo $row['des'];?>">
								</div>
							</div>
							<div class="col-lg-4">
								<h5>Event Image <span class="text-danger">(*)</span></h5>
				...
				<div class="col-lg-12">
					...
					<div class="col-lg-9" align="right">
							...
							<div class="col-lg-3">
					<button type="submit" name="updateEvents" class="btn btn-thm listing_save_btn mt30" href="#"><i class="fa fa-sign-in"></i> Submit</button>
					</div>
										<?php
						if($username == '')
						{
