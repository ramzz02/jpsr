<?php
	...
	{
		$id=$_GET['id'];
		$sql="select * from jpsrad where id='$id'";
					...
					<div class="page-title-box">
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">Business Ad</li>
							</ol>
						</div>
						<?php if(isset($_GET['id'])) {?>
							<h4 class="page-title"><a href="viewad.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i></a> Update Ad Details</h4>
							<?php } else { ?>
							<h4 class="page-title"><a href="viewad.php" class="btn btn-primary"><i class="fa fa-arrow-left"></i></a> Add New Ad</h4>
						<?php } ?>
					</div>
				</div>
			</div>
									...
									<form method="post" action="edit.php?id=<?php echo $id;?>" autocomplete="off" enctype="multipart/form-data">
										...
										<div class="col-lg-12">
											<div class="row">
												...
												<div class="col-lg-3">									
													<div class="form-floating mb-3">
														<select class="form-select" id="adpage" name="adpage" aria-label="Floating label select example">
															<?php
																if(isset($_GET['id']))
																{
																?>
																<option value="<?php echo $row['adpage'];?>"><?php echo $row['adpage'];?></option>
																<?php
																}
																else
																{
																?>
																<option selected>Select Ad Page</option>
																<?php
																}
															?>
														</select>
												...
												<div class="col-lg-3">									
													<div class="form-floating mb-3">
														<select class="form-select" id="adposition" name="adposition" aria-label="Floating label select example">
															<?php
																if(isset($_GET['id']))
																{
																?>
																<option value="<?php echo $row['adposition'];?>"><?php echo $row['adposition'];?></option>
																<?php
																}
																else
																{
																?>
																<option selected>Select Ad Position</option>
																<?php
																}
															?>
														</select>
												...
												<div class="col-lg-3">									
													<div class="form-floating mb-3">
														<select class="form-select" id="adcategory" name="adcategory" aria-label="Floating label select example">
															<?php
																if(isset($_GET['id']))
																{
																?>
																<option value="<?php echo $row['adcategory'];?>"><?php echo $row['adcategory'];?></option>
																<?php
																}
																else
																{
												...
												<div class="col-lg-4">
													<?php
														...
														{
														?>
														<input type="file" data-plugins="dropify" name="adimage" data-default-file="../uploads/<?php echo $row['adimage']; ?>"  />
														<?php
														}
														else
														{
														?>
														<input type="file" data-plugins="dropify" name="adimage" data-default-file="images/preview.jpg"  />
														<?php
														}
													?>
                                                    <p class="text-muted text-center mt-2 mb-0">Ad Image</>
												</div>
												<div class="col-lg-2">
													<?php
														if(isset($_GET['id']))
