...
<html dir="ltr" lang="en">
	...
	<p class="text-align-right Add_Btn_text" ><a href="register-ur-business.php" class="btn btn-thm btn-lg rounded"><i class="fa fa-briefcase"></i> Add your Business</a></p>
	<!-- Listing Grid View -->
							...
							<div class="feat_property list col-lg-12">
								...
								<div class="details col-lg-9">
									...
									<div class="fp_footer categVf">
										...
										<ul class="fp_meta mb0">
											<li class="list-inline-item"><a class="iconres view_profData" id="<?php echo $getbusinessdetail['id']; ?>" ><span class="flaticon-zoom"></span></a></li>
											<li class="list-inline-item"><a class="iconres" ><span class="flaticon-love"></span></a></li>
										</ul>
									</div>
								</div>
							</div>
