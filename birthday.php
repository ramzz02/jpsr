			...
			<div class="row">
				...
				<div class="col-lg-12 mb10">
					<div class="breadcrumb_content style2 mb25">
						<h2 class="breadcrumb_title text-thm"><i class="fa fa-briefcase"></i> Birthday Wishes</h2>
					</div>
				</div>
			</div>
			<div class="row justify-content-center">
				...
				<form action="add.php" method="post" enctype="multipart/form-data" autocomplete="off">
						...
						<div class="row">
							<div class="col-lg-3">
								<div class="my_profile_setting_input form-group">
							    	...
							    	<input type="text" class="form-control" name="birthdayperson" required placeholder="Enter the details here">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="my_profile_setting_input form-group">
							...
							<div class="col-lg-3">
								<div class="my_profile_setting_input form-group">
							    	...
							    	<input type="text" class="form-control" required name="sendername" value="<?php echo $names; ?>" placeholder="Enter the details here">
								</div>
							</div>
							<div class="col-lg-3">
								<div class="my_profile_setting_input form-group">
							    	<label for="listingPlace">Sender Contact <span class="text-danger">*</span></label>
							    	<input type="text" class="form-control" readonly name="contact" value="<?php if(isset($username)){ echo $username; }?>" readonly placeholder="Enter the details here">
								</div>
							</div>
							<div class="col-lg-2">
								<h5>Sender Image <span class="text-danger">(*)</span></h5>
							  	<div class="upload_file_input_add_remove">
							    	<span class="btn_upload"><input type="file" id="imag" title="" name="senderimage" required class="input-img"/><span class="flaticon-upload"></span></span>
							...
							<div class="col-lg-2">
								<h5>Birthday Image <span class="text-danger">(*)</span></h5>
							  	<div class="upload_file_input_add_remove">
							    	<span class="btn_upload"><input type="file" id="imag2" title="" name="birthdayimage" required class="input-img"/><span class="flaticon-upload"></span></span>
							...
							<div class="col-lg-8">
								<div class="my_profile_setting_textarea">
								    ...
								    <textarea class="form-control" name="wishes" required rows="5"></textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-9" align="right">
							...
							<div class="col-lg-3">
					<button name="submitbirthday" type="submit" class="btn btn-thm listing_save_btn mt30" href="#"><i class="fa fa-check-circle"></i> Submit</button>
					</div>
					</div>
					</div>
					</form>
