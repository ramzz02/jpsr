		...
		<div class="row">
			...
			<div class="col-xl-9" style="background:#fff"><br>
					...
					<form action="add.php" method="post" enctype="multipart/form-data" autocomplete="off">
										<div class="row">
											<input type="text" name="category" hidden value="business">
											...
											<div class="col-lg-6">
												<div class="my_profile_setting_input ui_kit_select_search form-group">
													...
													<select class="selectpicker" name="service" data-live-search="true" data-width="100%">
														...
														<option value="Advertisement Services">Advertisement Services</option>
														<option value="Establishment & Expansion">Establishment & Expansion</option>
