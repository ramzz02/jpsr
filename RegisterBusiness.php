...
<?php
  ...
  if(isset($_POST['registeryourbusiness'])){
    ...
    if($_POST['subscription_order'] == 3){
	    ...
	    $started_date = date("Y/m/d");
    } else if($_POST['subscription_order'] == 4){
    	$totalDays = '365 day';
	    $started_date = date("Y/m/d");
	    $started_date = strtotime($started_date);
	    $started_date = strtotime($totalDays, $started_date);
 ...
 //    $confm_PassPasd = openssl_decrypt($_SESSION['Marketing_User_login']['password'], "AES-128-ECB", SECRETKEY);
  ...
  $getplans = $getplans->fetchPlan("WHERE plan_code != 'CODE 06' ORDER BY id ASC LIMIT 2")->resultSet();
					...
					<form method="post" enctype="multipart/form-data" id="RegisterBusinessForm" autocomplete="off">
						...
						<div class="my_dashboard_review">
							<div class="row">
								...
								<div class="col-lg-4">
									<div class="my_profile_setting_input form-group">
										<label>User Mobile No <span class="text-danger"> (Not Editable) *</span></label>
										<input type="text" class="form-control" name="mobile_no" id="mobile_no" value="<?php if(isset($_SESSION['Marketing_User_login'])){ echo $_SESSION['Marketing_User_login']['phone']; }?>" placeholder="Your mobile no" maxlength="10" readonly>
									</div>
								</div>
								<div class="col-lg-4">
									<div class="my_profile_setting_input form-group">
										<label>Business Display Mobile No <span class="text-danger">*</span></label>
										<input type="text" class="form-control" name="business_mobile_no" id="business_mobile_no" placeholder="Your mobile no" maxlength="10">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="my_profile_setting_input form-group">
										<label>Business Email ID <span class="text-optional">(Optional)</span></label>
								...
								<div class="col-lg-4">
									<div class="my_profile_setting_input ui_kit_select_search form-group">
										...
										<select class="selectpicker col-lg-12 p0" required data-live-search="true" name="category" id="category" >
								...
								<div class="col-lg-4">
									<div class="my_profile_setting_input form-group">
										<label>Business Alternate Mobile No <span class="text-optional">(Optional)</span></label>
								...
								<div class="col-lg-4">
									<div class="my_profile_setting_input form-group">
										<label>Referred Agent Code <span class="text-optional">(Optional)</span></label>
										<input type="text" class="form-control" name="refered_by_code" id="business_refered_by_code" placeholder="Refered person code">
									</div>
								</div>
								<div class="col-lg-4">
									<div class="my_profile_setting_input form-group">
										<label>Referred Agent Name <span class="text-optional">(Optional)</span></label>
						...
						<div class="my_dashboard_review">
							<div class="row">
								...
								<div class="utf_booking_payment_option_form">
			                      <div class="payment">
			                        <div class="utf_payment_tab_block business_plan_tab">
				                        <div class="utf_payment_trigger_tab nodrop">
				                          ...
				                          <label for="free" style="width: 85%;">
				                          	CODE 01
				                          	[BASIC ALL BUSINESS REGISTRATION FORM] - <span class="amount_subs_pay">LIFE TIME</span>
				                          </label>
			                        ...
			                        <div class="utf_payment_tab_block business_plan_tab">
				                        <div class="utf_payment_trigger_tab nodrop">
				                          <input id="plan_1" name="plan_type" class="plan_click_Btn" type="radio" value="1" data-subscription-order="2" data-plan="1" data-price="1500" >
				                          <label for="plan_1" style="width: 85%;">
				                          	CODE 06 [ CODE 01 + LOGO or DISPLAY PICTURE(DP) ] - <span class="amount_subs_pay">LIFE TIME</span>
				                          </label>
				                          <span class="utf_payment_logo amount_subs_pay"><b>₹ 1,500 /-</b></span>
				                        </div>
			                        </div>
						...
						<div id="MediaPath_form">
							...
							<div class="my_dashboard_review">
								<div class="row">
									...
									<div class="col-lg-5"></div><div class="col-lg-2"></div>

									<div class="row col-lg-12" id="GalleryImgPath">

										<div class="col-lg-12">
											<div class="my_profile_setting_input form-group mb0">
												<label>Gallery Images <span class="text-danger">(Pay & Use) (Maximum 5 images only)</span></label>
											</div>
										</div>

										<div class="col-lg-4">
											<div class="my_profile_setting_input form-group">
												<input type="file"  class="form-control" name="gallery_images[]" id="gallery_images_1" onchange="galleryImage_1()">
												<span class="note">* Upload only image file </span>
												<div id="preview_gallery_1"></div>
											</div>
										</div>
										<div class="col-lg-4">
											<div class="my_profile_setting_input form-group">
												<input type="file"  class="form-control" name="gallery_images[]" id="gallery_images_2" onchange="galleryImage_2()">
												<span class="note">* Upload only image file </span>
												<div id="preview_gallery_2"></div>
											</div>
										</div>
										<div class="col-lg-4">
											<div class="my_profile_setting_input form-group">
												<input type="file"  class="form-control" name="gallery_images[]" id="gallery_images_3" onchange="galleryImage_3()">
												<span class="note">* Upload only image file </span>
												<div id="preview_gallery_3"></div>
											</div>
										</div>
										<div class="col-lg-4">
											<div class="my_profile_setting_input form-group">
												<input type="file"  class="form-control" name="gallery_images[]" id="gallery_images_4" onchange="galleryImage_4()">
												<span class="note">* Upload only image file </span>
												<div id="preview_gallery_4"></div>
											</div>
										</div>
										<div class="col-lg-4">
											<div class="my_profile_setting_input form-group">
												<input type="file"  class="form-control" name="gallery_images[]" id="gallery_images_5" onchange="galleryImage_5()">
												<span class="note">* Upload only image file </span>
												<div id="preview_gallery_5"></div>
											</div>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="utf_booking_payment_option_form">
			                      <div class="payment">
			                        <div class="utf_payment_tab_block">
			                        <div class="utf_payment_trigger_tab">
			                          <input id="upi" name="payment_type" type="radio" value="upi" class="payment_type_options" data-method-mode="1">
			                        ...
			                        <div class="utf_payment_tab_block_content">         
			                          <div class="row">
			                              ...
			                              <img src="images/pay_scanner.png" style="width:30%;">
			                                ...
			                                <div class="col-lg-6" id="paymentPaidScreenImg" style="display: none;">
												<div class="my_profile_setting_input form-group">
													<label>Payment Transfered Screenshot Image <span class="text-danger">*</span></label>
													<input type="file" id="payment_image" name="payment_image" onchange="validatePayemntImage()" class="form-control">
													<span class="note">* Upload only image file </span>
													<div id="preview_payment_image"></div>
												</div>
											</div>
			                        ...
			                        <div class="utf_payment_tab_block nodrop ">
			                          <div class="utf_payment_trigger_tab nodrop">
			                            <input checked id="creditCart" name="payment_type" type="radio" value="online" class="payment_type_options" data-method-mode="2">
						...
						<div class="row mb80">
							<div class="col-lg-9 pl0 pr0 pl15-767 pr15-767 text-align-left"><br>
								...
								<div class="weblink_share">
									...
									<span><a id="whatsapp" class="frontend_whatsapp mb10" href="https://api.whatsapp.com/send?text=https://jpsr.in/RegisterBusiness" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i> WhatsApp</a></span>

									<span><a id="facebook" class="frontend_facebook mb10" href="http://www.facebook.com/sharer.php?u=https://jpsr.in/RegisterBusiness" target="_blank"><i class="fa fa-facebook-f" aria-hidden="true"></i> Facebook</a></span>
					
									<span><a id="twitter" class="frontend_twitter mb10" href="https://twitter.com/intent/tweet?url=https://jpsr.in/RegisterBusiness" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i> Twitter</a></span>

									<span><a id="linkedin" class="frontend_linkedIn mb10" href="http://www.linkedin.com/shareArticle?url=https://jpsr.in/RegisterBusiness" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i> Linked In</a></span>
...
<script type="text/javascript">
	...
	$(document).on('click', '.payment_type_options', function() {

		var Methodmode =  $(this).attr('data-method-mode');

		if(Methodmode == 1){
			$('#paymentPaidScreenImg').show();
		} else {
			$('#paymentPaidScreenImg').hide();
		}
