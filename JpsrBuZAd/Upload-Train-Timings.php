...
<?php
  ...
  if(isset($_POST['AddExcel'])){
      ...
      if(isset($_FILES['uploadFile']['name']) && $_FILES['uploadFile']['name'] != "") {
        ...
        $deletefile = $deletefile->removeTrainLocation($da_up);
       ...
       header("Location: Upload-Train-Timings");
        ...
        <main class="main-wrapper clearfix" style="min-height: 673px;">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Upload Train Timings</h6>
                </div>
                <!-- /.page-title-left -->
                                ...
                                <form method="post" id="UploadExcel" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <span class="note"><a href="train-timings-excel-format.xlsx">Click here</a> to download excel format</span>
                                        </div>
                                    </div>
