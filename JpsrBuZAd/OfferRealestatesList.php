...
<?php
  ...
  if(isset($_POST['delete_id'])){
    ...
    $getimages = new Offer();
    $getimages = $getimages->fetchIndustry("WHERE id = '{$_POST['delete_id']}' ORDER BY id DESC")->resultSet();
    $getimage = $getimages[0];

    $img_path = $getimage['image_path'];

    $deletefile = new Offer();
    $deletefile = $deletefile->removeIndustry($data);
...
$getofferbanners = $getofferbanners->fetchIndustry("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Realestates Offers List</h6>
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Realestates List</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                                ...
                                <table class="table table-editable table-responsive" data-toggle="datatables" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../<?php echo $getofferbanner['image_path']; ?>" style="width: 200px;"></td>
...
<script type="text/javascript">
  $(document).on('click', '.edit', function() {                  
        ...
        $('#tableForm').attr('action', 'OfferRealestates.php');
        $('#tableForm').submit();
    });
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('method', 'post');
          $('#tableForm').attr('action', 'OfferRealestatesList.php');
          $('#tableForm').submit();
      }            
  });
</script>
