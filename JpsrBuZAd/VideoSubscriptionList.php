...
$getsubs = $getsubs->fetchSubscription("WHERE type = '3' ORDER BY period DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Business Video Subscription</h6>
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Video Subscription List</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
...
<script type="text/javascript">
  $(document).on('click', '.edit', function() {                  
        ...
        $('#tableForm').attr('action', 'AddVideoSubscription');
        $('#tableForm').submit();
    });
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('method', 'post');
          $('#tableForm').attr('action', 'VideoSubscriptionList');
          $('#tableForm').submit();
      }            
  });
