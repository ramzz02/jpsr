...
<?php
  ...
  if(isset($_POST['delete_id'])){
    ...
    $deletefile = $deletefile->removeHomeService($data);
    ...
    header('Location: Home-Services-List');
...
$getservices = $getservices->fetchHomeService("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Home Services List</h6>
                </div>
                <!-- /.page-title-left -->
...
<script type="text/javascript">
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('action', 'Home-Services-List');
          $('#tableForm').submit();
      }            
  });
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=home_service",
