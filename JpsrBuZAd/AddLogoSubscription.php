...
<?php
  ...
  if(isset($_SESSION['subs_exists'])){
    ...
    if(isset($_POST['subsSubmit'])){
        ...
        $existssubs = $existssubs->fetchSubscription("WHERE type = '1' AND period = '{$_POST['period']}' ORDER BY id DESC")->resultSet();
       ...
       header("Location: AddLogoSubscription");
    ...
    if(isset($_POST['subsUpdate'])){
        ...
        $existssubs = new Business();
        $existssubs = $existssubs->fetchSubscription("WHERE id != '{$_POST['subs_id']}' AND type = '1' AND period = '{$_POST['period']}' ORDER BY id DESC")->resultSet();
        $existssub = $existssubs[0];
        ...
        <main class="main-wrapper clearfix" style="min-height: 673px;">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">New Business Logo Subscription</h6>
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php if($getcontent){ ?>Update<?php } else { ?>Add<?php } ?> Logo Subscription</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
