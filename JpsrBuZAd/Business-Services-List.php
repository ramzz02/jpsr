...
<?php
  ...
  if(isset($_POST['delete_id'])){
    ...
    $deletefile = $deletefile->removeBusinessService($data);
    ...
    header('Location: Business-Services-List');
...
$getservices = $getservices->fetchBusinessService("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Business Services List</h6>
                </div>
                <!-- /.page-title-left -->
...
<script type="text/javascript">
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('action', 'Business-Services-List');
          $('#tableForm').submit();
      }            
  });
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=business_service",
