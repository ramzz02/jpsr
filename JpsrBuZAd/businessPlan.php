...
$getplans = $getplans->fetchPlan("ORDER BY id ASC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Business Plan</h6>
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Business Plan List</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                                ...
                                <table class="table table-editable table-responsive" data-toggle="datatables" >
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:15%;">Plan Code</th>
                                            <th>Plan Name</th>
...
<script type="text/javascript">
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=business_plan",
