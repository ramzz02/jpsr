...
<?php
  ...
  date_default_timezone_set('Asia/Kolkata');
    ...
    if($_SESSION['category_exists']){
      $output = "Update failed. Category already added";
    }
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Business Category</h6>
                </div>
                <!-- /.page-title-left -->
                                ...
                                <table class="table table-editable table-responsive" data-toggle="datatables" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($getcategory['category_image'] != ''){ ?>
                                            <td><img src="../<?php echo $getcategory['category_image']; ?>" style="width: 20%;"></td>
                                            <?php } else { ?>
                                            <td>-</td>
                                            <?php } ?>
                                            <td>
                                            <label class="switch">
                                            <input class="switch-input" type="checkbox" name="checkbox" <?php if($getcategory['status'] == '1'){ echo 'checked'; } ?> />
...
<script type="text/javascript">
  $(document).on('click', '.edit', function() {                  
        ...
        $('#tableForm').attr('action', 'addbusinesscategory');
        $('#tableForm').submit();
    });
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('method', 'post');
          $('#tableForm').attr('action', 'businesscategoryList');
          $('#tableForm').submit();
      }            
  });
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=business_category",
