  ...
  if(isset($_SESSION['content_added'])){
   ...
   if(isset($_SESSION['content_updated'])){
    ...
    if(isset($_POST['addtrustSubmit'])){
      ...
      if(isset($_POST['updatetrustSubmit'])){
       ...
       $updatenew = new Trust();
       $updatenew = $updatenew->updateContent($data);
    ...
    $getfiles = new Trust();
    $getfiles = $getfiles->fetchContent("ORDER BY id DESC")->resultSet();
    $getfile = $getfiles[0];
        ...
        <main class="main-wrapper clearfix" style="min-height: 673px;">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Trust</h6>
                </div>
                <!-- /.page-title-left -->
                            ...
                            <div class="widget-body clearfix">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="ml-auto col-sm-9 no-padding">
                                        <?php if($getfile){ ?>
                                        <button class="btn btn-primary" type="submit" id="update_submit" name="updatetrustSubmit">Update</button>
                                        <?php } else { ?>
                                        <button class="btn btn-primary" type="submit" id="add_submit" name="addtrustSubmit">Submit</button>
                                        <?php } ?>
