...
<?php
  ...
  if(isset($_POST['delete_id'])){
    ...
    $deletefile = $deletefile->removeDoctorService($data);
...
$getservices = $getservices->fetchDoctorService("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Doctor Appointment</h6>
                </div>
                <!-- /.page-title-left -->
                                ...
                                <table class="table table-editable table-responsive display compact responsive nowrap" data-toggle="datatables" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <?php } ?>
                                            <td><?php echo $getservice['specialist']; ?></td>
                                            <td><?php echo $getservice['doctor_name']; ?></td>
                                            <td><?php echo $getservice['appointment_date']; ?><br><?php echo $getservice['timings']; ?></td>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=doctor_service",
