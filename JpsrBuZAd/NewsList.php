...
<?php
  ...
  if(isset($_SESSION['news_updated'])){
    ...
    $getimages = new News();
    $getimages = $getimages->fetchNews("WHERE id = '{$_POST['delete_id']}' ORDER BY id DESC")->resultSet();
    ...
    $deletefile = new News();
    $deletefile = $deletefile->removeNews($data);
...
$getnewsLists = $getnewsLists->fetchNews("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">News List</h6>
                </div>
                <!-- /.page-title-left -->
                            ...
                            <div class="widget-body clearfix table-list" style="width: 100%;overflow-y: auto;">
                                ...
                                <table class="table table-editable table-responsive display compact responsive nowrap" data-toggle="datatables" >
                                    ...
                                    <tbody>
                                        ...
                                        if($getnewsList['language'] == 1){
                                          $langName = "English";
                                        } else if($getnewsList['language'] == 2){
                                          $langName = "Tamil";
                                        } else if($getnewsList['language'] == 3){
                                          $langName = "Telugu";
                                        } else if($getnewsList['language'] == 4){
                                          $langName = "Kannada";
                                        } else if($getnewsList['language'] == 5){
                                          $langName = "Malayalam";
                                        }
                                        ...
                                        <tr>
                                            ...
                                            $getcategorys = new News();
                                            $getcategorys = $getcategorys->fetchCategory("WHERE id = '{$getnewsList['category']}' ORDER BY id ASC")->resultSet();
                                            ...
                                            <td>
                                              <?php if($getnewsList['category'] == 'type1'){ echo 'International News'; } else if($getnewsList['category'] == 'type2'){ echo 'National News'; } else if($getnewsList['category'] == 'type3'){ echo 'State News'; } else if($getnewsList['category'] == 'type4'){ echo 'Astrology'; }else { echo $getcategory['category_name']; } ?>
                                            </td>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('method', 'post');
          $('#tableForm').attr('action', 'NewsList');
          $('#tableForm').submit();
      }            
  });
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=news",
