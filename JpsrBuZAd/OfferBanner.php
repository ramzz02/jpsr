...
<?php
  ...
  if(isset($_SESSION['banner_exists'])){
    if($_SESSION['banner_exists']){
      $output = "Failed to add. Maximum 10 images allowed";
    }
    unset($_SESSION['banner_exists']);
    }
  ...
  $getbanners = new Offer();
  $getbanners = $getbanners->fetchBanner("ORDER BY id DESC")->resultSet();
  if(count($getbanners) == 10){
    $_SESSION['banner_exists'] = true;
  } else {

   $addnew = new Offer();
   $addnew = $addnew->addBanner($data);
   ...
   if($addnew_id){
    ...
    header("Location: OfferBanner.php");
  ...
  if(isset($_POST['update_submit'])){
   ...
   $editfiles = new Offer();
   $editfiles = $editfiles->fetchBanner("WHERE id ='{$_POST['banner_id']}'")->resultSet();
   ...
   $updatenew = new Offer();
   $updatenew = $updatenew->updateBanner($data);
        ...
        <main class="main-wrapper clearfix" style="min-height: 673px;">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Offer Banner</h6>
                </div>
                <!-- /.page-title-left -->
