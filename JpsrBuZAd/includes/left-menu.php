...
$Class90=($CrPage=='Addstate.php')?'active':'';
$Class91=($CrPage=='StateList.php')?'active':'';

$Class92=($CrPage=='AddDistrict.php')?'active':'';
$Class93=($CrPage=='DistrictList.php')?'active':'';
...
$Class94=($CrPage=='businessPlan.php')?'active':'';
$Class95=($CrPage=='BusinessSubscription.php')?'active':'';
$Class96=($CrPage=='BusinessSubscriptionList.php')?'active':'';


$Class100=($CrPage=='AddUser.php')?'active':'';
$Class101=($CrPage=='EditUser.php')?'active':'';

$Class110=($CrPage=='agentList.php')?'active':'';
$Class111=($CrPage=='EditAgentProfile.php')?'active':'';
...
<aside class="site-sidebar scrollbar-enabled" data-suppress-scroll-x="true">
    ...
    <nav class="sidebar-nav">
        <ul class="nav in side-menu">
            <li class="menu-item-has-children <?php if($Class39 == 'active' || $Class44 == 'active' || $Class73 == 'active' || $Class74 == 'active' || $Class6 == 'active' || $Class15 == 'active' || $Class16 == 'active' || $Class35 == 'active' || $Class36 == 'active' || $Class37 == 'active' || $Class38 == 'active' || $Class90 == 'active' || $Class91 == 'active' || $Class92 == 'active' || $Class93 == 'active' || $Class100 == 'active' || $Class101 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-home"></i> <span class="hide-menu">Home Page</span></a>
                <ul class="list-unstyled sub-menu">
                   <!-- <li><a class="<?php echo $Class6; ?>" href="aboutus">About us</a>
                    </li> -->
                    <li ><a class="<?php echo $Class100; ?>" href="AddUser">Add New User</a>
                    </li>
                    ...
                    <li class="menu-item-has-children <?php if($Class73 == 'active' || $Class74 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">Help</a>
                        <ul class="list-unstyled sub-menu">
                    ...
                    <li class="menu-item-has-children <?php if($Class15 == 'active' || $Class16 == 'active' || $Class35 == 'active' || $Class36 == 'active' || $Class37 == 'active' || $Class38 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">We are available</a>
                        <ul class="list-unstyled sub-menu">
                    ...
                    <li class="menu-item-has-children <?php if($Class90 == 'active' || $Class91 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">State</a>
                        <ul class="list-unstyled sub-menu">
                            <li ><a class="<?php echo $Class90; ?>" href="Addstate">Add State</a>
                            </li>
                            <li ><a class="<?php echo $Class91; ?>" href="StateList">State List</a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children <?php if($Class92 == 'active' || $Class93 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">District</a>
                        <ul class="list-unstyled sub-menu">
                            <li ><a class="<?php echo $Class92; ?>" href="AddDistrict">Add District</a>
                            </li>
                            <li ><a class="<?php echo $Class93; ?>" href="DistrictList">District List</a>
                            </li>
                        </ul>
                    </li>
                </ul>
            ...
            <li class="menu-item-has-children <?php if($Class2 == 'active' || $Class3 == 'active' || $Class4 == 'active' || $Class5 == 'active' || $Class18 == 'active' || $Class19 == 'active' || $Class68 == 'active' || $Class82 == 'active' || $Class83 == 'active' || $Class84 == 'active' || $Class85 == 'active' || $Class94 == 'active' || $Class95 == 'active' || $Class96 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-layout"></i> <span class="hide-menu">Register Your Business</span></a>
                <ul class="list-unstyled sub-menu">
                    ...
                    <li ><a class="<?php echo $Class94; ?>" href="businessPlan">Business Plan</a>
                    </li>
                    <li ><a class="<?php echo $Class95; ?>" href="BusinessSubscription">Add Business Subscription</a>
                    </li>
                    <li ><a class="<?php echo $Class96; ?>" href="BusinessSubscriptionList">Business Subscription List</a>
                    </li>
             ...
             <li class="menu-item-has-children <?php if($Class22 == 'active' || $Class23 == 'active' || $Class47 == 'active' || $Class24 == 'active' || $Class25 == 'active' || $Class45 == 'active' || $Class26 == 'active' || $Class27 == 'active' || $Class46 == 'active' || $Class40 == 'active' || $Class41 == 'active' || $Class42 == 'active' || $Class43 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-layout"></i> <span class="hide-menu">Business Directory</span></a>
                <ul class="list-unstyled sub-menu">
                    <!--<li class="menu-item-has-children <?php if($Class22 == 'active' || $Class23 == 'active' || $Class47 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">Emergency Services</a>-->
                    <!--    <ul class="list-unstyled sub-menu">-->
                    ...
                    <!--    </ul>-->
                    <!--</li>-->
                    <!--<li class="menu-item-has-children <?php if($Class24 == 'active' || $Class25 == 'active' || $Class45 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">Train Timings</a>-->
                    <!--    <ul class="list-unstyled sub-menu">-->
                    ...
                    <!--    </ul>-->
                    <!--</li>-->
                    <!--<li class="menu-item-has-children <?php if($Class26 == 'active' || $Class27 == 'active' || $Class46 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">Bus Timings</a>-->
                    <!--    <ul class="list-unstyled sub-menu">-->
                    ...
                    <!--    </ul>-->
                    <!--</li>-->
                    <!--<li class="menu-item-has-children <?php if($Class40 == 'active' || $Class41 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">Government Offices</a>-->
                    <!--    <ul class="list-unstyled sub-menu">-->
                    ...
                    <!--    </ul>-->
                    <!--</li>-->
                    <li class="menu-item-has-children <?php if($Class42 == 'active' || $Class43 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);">Temples</a>
                        <ul class="list-unstyled sub-menu">
            ...
            <li class="menu-item-has-children <?php if($Class110 == 'active' || $Class111 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-feather"></i> <span class="hide-menu">JPSR Agent</span></a>
                <ul class="list-unstyled sub-menu">
                    <li ><a class="<?php echo $Class110; ?>" href="agentList">Agent List</a>
                    </li>
                </ul>
            </li>
            
<!--             <li class="menu-item-has-children <?php if($Class28 == 'active' || $Class29 == 'active' || $Class30 == 'active' || $Class31 == 'active' || $Class32 == 'active' || $Class33 == 'active' || $Class34 == 'active' || $Class50 == 'active' || $Class51 == 'active' || $Class69 == 'active' || $Class70 == 'active' || $Class71 == 'active' || $Class86 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-feather"></i> <span class="hide-menu">JPSR Services</span></a>
                <ul class="list-unstyled sub-menu">
                    ...
                    <li ><a class="<?php echo $Class86; ?>" href="QueryList">Home JPSR Query List</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu-item-has-children <?php if($Class60 == 'active' || $Class61 == 'active' || $Class66 == 'active' || $Class67 == 'active' || $Class76 == 'active' || $Class79 == 'active' || $Class80 == 'active' || $Class77 == 'active' || $Class78 == 'active' || $Class62 == 'active' || $Class63 == 'active' || $Class64 == 'active' || $Class65 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-sidebar"></i> <span class="hide-menu">News</span></a>
                <ul class="list-unstyled sub-menu">
            ...
            <li class="menu-item-has-children <?php if($Class48 == 'active' || $Class49 == 'active' || $Class87 == 'active' || $Class88 == 'active' || $Class17 == 'active'){ echo 'active'; }  ?>"><a href="javascript:void(0);"><i class="list-icon feather feather-list"></i> <span class="hide-menu">Footer</span></a>
                <ul class="list-unstyled sub-menu">
