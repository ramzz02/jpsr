...
<?php
  ...
  if(isset($_POST['delete_id'])){
    ...
    $deletefile = $deletefile->removeRentingService($data);
...
$getservices = $getservices->fetchRentingService("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Renting Services List</h6>
                </div>
                <!-- /.page-title-left -->
                                ...
                                <table class="table table-editable table-responsive display compact responsive nowrap" data-toggle="datatables" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>-</td>
                                            <?php } ?>
                                            <td><?php echo $getservice['renting']; ?><br><?php echo $getservice['property_address']; ?></td>
...
<script type="text/javascript">
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('action', 'Renting-List');
          $('#tableForm').submit();
      }            
  });
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=renting_service",
