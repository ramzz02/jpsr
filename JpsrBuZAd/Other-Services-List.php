...
<?php
  ...
  if(isset($_POST['delete_id'])){
    ...
    $deletefile = $deletefile->removeOtherService($data);
    ...
    header('Location: Other-Services-List');
...
$getservices = $getservices->fetchOtherService("ORDER BY id DESC")->resultSet();
        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Other Services List</h6>
                </div>
                <!-- /.page-title-left -->
...
<script type="text/javascript">
  $(document).on('click', '.delete', function() {   
      ...
      if (confirm_msg == true) {
          ...
          $('#tableForm').attr('action', 'Other-Services-List');
          $('#tableForm').submit();
      }            
  });
  $(document).on('click', '.active_update', function() {   
          ...
          $.ajax({
            ...
            data: "update_id="+profile_id+"&name=other_service",
