...
<?php
  ...
  $BuzzExplode =explode("/", $_GET['profID_view']);

  $viewprofiledetails = new Business();
  $viewprofiledetails = $viewprofiledetails->fetchBusiness("WHERE id = '{$BuzzExplode[0]}' ")->resultSet();
  $viewprofiledetail = $viewprofiledetails[0];
  
  $getbuzzcategorys = new Business();
  $getbuzzcategorys = $getbuzzcategorys->fetchCategory("WHERE id = '{$viewprofiledetail['category']}' ORDER BY category_name ASC")->resultSet();
  $getbuzzcategory = $getbuzzcategorys[0];

  $app_business_name = str_replace(" ", "-", $viewprofiledetail['business_name']);
  $app_user_credentials = $getbuzzcategory['category_name'];

  if($viewprofiledetail['logo'] != ''){

  	$webSi_URlug = $web_link.'/'.$viewprofiledetail['logo'];
  ...
  if($viewprofiledetail['logo'] != ''){
	...
	if($gallery_Success == 1){
		...
		$galleryBuzImages = $galleryBuzImages->fetchBusinessImage("WHERE business_id = '{$BuzzExplode[0]}' ORDER BY id DESC LIMIT 5")->resultSet();
		...
		<div class="container">
			<div class="row">
					...
					<div class="single_property_title">
						<div class="media">
							...
							<div class="col-lg-9 media-body mt0">
						    	<h3 class="mt-0 prof_NMKQ_d"><?php echo $viewprofiledetail['business_name']; ?></h3>
						    	<div class="prof_NMKQ_M">
						    		<h4 class="mt-0 mb0"><?php echo $viewprofiledetail['business_name']; ?></h4>
						    	...
						    	<div class="col-lg-12 pl0 pr0 prof_NMKQ_d">
								    ...
								    <div class="col-lg-7 pr0 float-left split_business2">
								    	...
								    	<div class="color-black mb5"><span class="flaticon-pin mr5"></span><?php echo $viewprofiledetail['address']; ?>, <?php echo $viewprofiledetail['area']; ?>, <?php echo $viewprofiledetail['city']; ?></div>
								    	...
								    	<?php if($viewprofiledetail['alternative_mobile_no'] != ''){ ?>
								    	<div class="mb5"><a class="color-black" href="tel:<?php echo $viewprofiledetail['alternative_mobile_no']; ?>"><span class="flaticon-phone"></span> <?php echo $viewprofiledetail['alternative_mobile_no']; ?></a></div>
								    	<?php } ?>
				...
				<div class="col-lg-12 prof_NMKQ_M mt15 p0">
					...
					<div class="col-lg-12 new_J_qO">
						<span class="col-lg-2 flaticon-phone clock_NB_W font-weight-600 pl-1 pr-1 pt0 pb0" ></span>
						<span class="col-lg-9 pin_addres font-s-18">
							<?php echo $viewprofiledetail['mobile_no']; ?> <?php if($viewprofiledetail['alternative_mobile_no'] != ''){ echo ', '.$viewprofiledetail['alternative_mobile_no']; } ?>
						</span>
						<div class="clear-both"></div>
					</div>

					<div class="col-lg-12 new_J_qO">
						<span class="col-lg-2 flaticon-email clock_NB_W font-weight-600 pl-1 pr-1 pt0 pb0" ></span>
						<span class="col-lg-9 pin_addres font-s-18">
							<?php if($viewprofiledetail['email'] != ''){ echo $viewprofiledetail['email']; } else { echo 'Add your email'; } ?>
						</span>
						<div class="clear-both"></div>
					</div>
					...
					<div class="col-lg-12 new_J_qO">
						...
						<span class="col-lg-9 pin_addres"><?php echo $viewprofiledetail['address']; ?>, <?php echo $viewprofiledetail['area']; ?>, <?php echo $viewprofiledetail['city']; ?></span>
						<div class="clear-both"></div>
					</div>
				...
				<div class="col-lg-12 prof_NMKQ_M mt15">
					    ...
					    <div class="col-lg-3 icon float-left Icon_view">
					    	<a href="https://www.google.com/maps/search/<?php echo $viewprofiledetail['address']; ?>,<?php echo $viewprofiledetail['area']; ?>,<?php echo $viewprofiledetail['city']; ?>">
				...
				<div class="col-lg-12 pl0 pr0 pl15-767 pr15-767 text-align-right"><br>
					...
					<div class="link_share">
						...
						<span><a id="whatsapp" class="frontend_whatsapp" href="https://api.whatsapp.com/send?text=<?php echo $actual_link; ?>" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i> Share</a></span>

						<span><a id="facebook" class="frontend_facebook " href="http://www.facebook.com/sharer.php?u=<?php echo $actual_link; ?>" target="_blank"><i class="fa fa-facebook-f" aria-hidden="true"></i> Share</a></span>
		
						<span><a id="twitter" class="frontend_twitter" href="https://twitter.com/intent/tweet?url=<?php echo $actual_link; ?>" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i> Share</a></span>

						<span><a id="direction" class="frontend_whatsapp" href="http://www.linkedin.com/shareArticle?url=<?php echo $actual_link; ?>" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i> Share</a></span>
							...
							<div class="listing_single_video">
								<div class="property_video">
									<div class="thumb">
										...
										<iframe style="height: 220px;" controls src="<?php echo $video_base64_IMg; ?>" type="video/mp4" allowfullscreen nodownload></iframe>
										<?php } else { ?>
