	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xl-9" style="background:#fff"><br>
					...
					<div class="row">
											<input type="text" name="category" hidden value="home">
											...
											<div class="col-lg-6">
												<div class="my_profile_setting_input ui_kit_select_search form-group">
													...
													<select class="selectpicker" name="service" data-live-search="true" data-width="100%">
														...
														<option value="Medicine (Tablets)">Medicine (Tablets)</option>
														<option value="Vegetables">Vegetables</option>
														<option value="Ration">Ration</option>
														<option value="Bill Payments">Bill Payments</option>
														<option value="TNEB">TNEB</option>
														<option value="Property & Water tax">Property & Water tax</option>
